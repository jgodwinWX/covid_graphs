...
for state in states:
    ...
    cell1 = '\t<td><a href="/images/covid/positive_%s.png"><button type="button" class="btn btn-info"></button></a></td>\n' % state
    cell2 = '\t<td><a href="/images/covid/deaths_%s.png"><button type="button" class="btn btn-info"></button></a></td>\n' % state
    cell3 = '\t<td><a href="/images/covid/testpos_%s.png"><button type="button" class="btn btn-info"></button></a></td>\n' % state
    cell4 = '\t<td><a href="/images/covid/week_positive_%s.png"><button type="button" class="btn btn-info"></button></a></td>\n' % state
